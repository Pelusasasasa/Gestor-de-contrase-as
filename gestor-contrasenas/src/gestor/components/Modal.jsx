...
export const Modal = ({closeModal}) => {
    ...
    const {title, username, password, desc, onInputChange, formState} = useForm(initialForm);
        ...
        <div className='bg-white p-8 rounded-lg shadow-lg w-full max-w-md'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className='mb-4'>
                    ...
                    <textarea  id="descripcion" name='descripcion' onChange={onInputChange}  value={desc} className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" rows={3} placeholder='Agregar una descripcion (opcional)'></textarea>
                </div>

                {/* Botones */}
                <div className='flex justify-end gap-4'>
                    <button type='button' className='cursor-pointer px-4 py-2 text-gray-600 hover:text-gray-800 focus:outline-none'>Cancelar</button>
